...
from transformers import BertModel, BertForMultipleChoice, BertTokenizer, XLNetModel, XLNetTokenizer
...
class BERT_Classifier(nn.Module):
    ...
    def __init__(self, y_size=4):
        ...
        # 分類のための追加レイヤー
        self.classifier = nn.Linear(self.max_seq_len*768, y_size)
    ...
    def forward(self, x_a, x_b):
        ...
        h, _ = self.bert(tokens, token_type_ids=token_types)
